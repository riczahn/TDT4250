...
public class GenerateJavaCode extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "generateJavaCode" };
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(JavaModelPackage.class)) {
        	EPackage.Registry.INSTANCE.put(JavaModelPackage.eNS_URI, JavaModelPackage.eINSTANCE);
        }
