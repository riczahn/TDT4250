...
import JavaModel.SimpleDatatype;
import JavaModel.Statement;
import JavaModel.TestClass;
import JavaModel.Visibility;
 ...
 * </p>
 * <ul>
 *   <li>{@link JavaModel.impl.MethodImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link JavaModel.impl.MethodImpl#getName <em>Name</em>}</li>
 *   <li>{@link JavaModel.impl.MethodImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link JavaModel.impl.MethodImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link JavaModel.impl.MethodImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link JavaModel.impl.MethodImpl#getTestClass <em>Test Class</em>}</li>
 * </ul>
 *
 * @generated
 */
