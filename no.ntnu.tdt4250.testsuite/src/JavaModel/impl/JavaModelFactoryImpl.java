...
public class JavaModelFactoryImpl extends EFactoryImpl implements JavaModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case JavaModelPackage.TEST_CLASS: return createTestClass();
			case JavaModelPackage.METHOD: return createMethod();
			case JavaModelPackage.LINE_STATEMENT: return createLineStatement();
			default:
	...
	public LineStatement createLineStatement() {
		LineStatementImpl lineStatement = new LineStatementImpl();
