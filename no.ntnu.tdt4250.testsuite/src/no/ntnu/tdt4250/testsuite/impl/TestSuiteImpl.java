 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.testsuite.impl.TestSuiteImpl#getName <em>Name</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.testsuite.impl.TestSuiteImpl#getTestCases <em>Test Cases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TestSuiteImpl extends MinimalEObjectImpl.Container implements TestSuite {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestsuitePackage.TEST_SUITE__NAME, oldName, name));
	}
	...
	public EList<TestCase> getTestCases() {
		if (testCases == null) {
			testCases = new EObjectContainmentWithInverseEList<TestCase>(TestCase.class, this, TestsuitePackage.TEST_SUITE__TEST_CASES, TestsuitePackage.TEST_CASE__TEST_SUITE);
		}
		return testCases;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestsuitePackage.TEST_SUITE__NAME:
				return getName();
			case TestsuitePackage.TEST_SUITE__TEST_CASES:
				return getTestCases();
		}
